...
public class PesquisaSequencial extends PesquisaArray{
     ...
     * @return boolean - true caso a estrutura contenha a palavra, false caso contrário
     */
    ...
    /**Método para realizar a pesquisa sequencial, percorrendo a estruturas de dados
     * tentando encontrar a palavra informada
     *
     * @author Gabriel Haddad
     * @param palavraBusca String - palavra a ser buscada na estrutura de dados
     * @return ElementoFrase - retorna o objeto que encapsula a palavra na estrutura de dados,
     * contendo a quantidade de aparições dessa palavra no texto
     */
